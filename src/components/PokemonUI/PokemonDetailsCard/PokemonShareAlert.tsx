...
const PokemonShareAlert: React.FC<TPokemonShareAlertProps> = ({
  ...
  return (
    <div className="mb-2 flex flex-col items-center justify-center rounded-lg bg-blue-50 p-3">
      ...
      {sharedData?.caughtAt && (
        <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4 w-full">
          <p className="w-full text-sm font-medium text-green-800">
            <span className="flex">
              <Check />
